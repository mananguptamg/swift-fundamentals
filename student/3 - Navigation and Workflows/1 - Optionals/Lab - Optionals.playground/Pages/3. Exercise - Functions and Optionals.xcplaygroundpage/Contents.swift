...
var prices = ["Chips": 2.99, "Pastry": 1.89, "Lays": 3.99, "Apple": 0.50, "Banana": 0.25, "Potato": 0.99]
var stock = ["Chips": 4, "Pastry": 0, "Lays": 12, "Apple": 6, "Banana": 6, "Potato": 3]
...
print(price(item: "Pastry"))
print(price(item: "Lays"))
/*:
