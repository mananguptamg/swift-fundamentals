...
favoriteBook.title = "Swift Fundamentals"
favoriteBook.author = "Apple"
favoriteBook.pages = 650
favoriteBook.price = 24.99

print("\(favoriteBook.title) by \(favoriteBook.author). It has \(favoriteBook.pages) pages and it's price is \(favoriteBook.price).")
/*:
