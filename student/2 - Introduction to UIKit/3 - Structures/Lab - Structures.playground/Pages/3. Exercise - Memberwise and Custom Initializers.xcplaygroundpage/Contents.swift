...
var favoriteBook = Book(title: "Swift Fundamentals", author: "Apple", pages: 644, price: 499)

print("\(favoriteBook.title) by \(favoriteBook.author) has \(favoriteBook.pages) pages and it's price is \(favoriteBook.price).")
/*:
...
struct Laptop {
    var screenSize: Double = 13.0
    var repairCount: Int = 0
    var yearPurchased: Int
}

var latestWindowsLaptop = Laptop(screenSize: 15.5, repairCount: 0,yearPurchased: 2024)
var oldWindowsLaptop = Laptop(screenSize: 13.0, repairCount: 3, yearPurchased: 2018)
/*:
...
var myHeightIN = Height(heightInInches: 65)
print(myHeightIN.heightInCentimeters)
...
var myHeightCM = Height(heightInCentimeters: 165)
print(myHeightCM.heightInInches)
/*:
