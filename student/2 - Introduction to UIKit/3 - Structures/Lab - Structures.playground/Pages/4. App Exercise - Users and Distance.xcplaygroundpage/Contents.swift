...
var Manan = User(name: "Manan", age: 20, height: 5.8, weight: 71, activityLevel: 4)
print("My name is \(Manan.name). My age is \(Manan.age) my height is \(Manan.height) my weight is \(Manan.weight) and my activity level is \(Manan.activityLevel)." )
/*:
...
let distanceInMeter  = Distance(feet: 5249.344)
print(distanceInMeter.meters)
/*:
