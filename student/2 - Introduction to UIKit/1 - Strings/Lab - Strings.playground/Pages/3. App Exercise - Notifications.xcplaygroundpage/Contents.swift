...
let newBest = 15125
let congratulations = "Congratulations,\(firstName) \(lastName)! You beat your previous daily high score of \(previousBest) steps by walking \(newBest) steps yesterday!"
